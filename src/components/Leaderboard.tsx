...
const Leaderboard = () => {
    const leaderboard = [
        {
            name: 'Bayu Catur',
            photo: 'https://image.flaticon.com/icons/png/512/2945/2945467.png',
            xp: 4269,
        },
        {
                ...
                <section className="flex flex-row justify-center items-center mb-8">
                    <span className="text-center mx-2">
                        <div className="relative mb-3">
                            <div className="w-22 h-22 flex justify-center items-end bg-gray-100 text-gray-400 border-3 border-white rounded-full shadow-default overflow-hidden focus:outline-none">
                    ...
                    <span className="text-center mx-2">
                        <div className="relative mb-3">
                            <div className="w-24 h-24 flex justify-center items-end bg-gray-100 text-gray-400 border-3 border-white rounded-full shadow-default overflow-hidden focus:outline-none">
                        ...
                        <h2 className="font-bold text-lg leading-none">Bayu C.</h2>
                        <span className="text-sm font-bold text-gray-500">4269 XP</span>
                    </span>

                    <span className="text-center mx-2">
                        <div className="relative mb-3">
                            <div className="w-20 h-20 flex justify-center items-end bg-gray-100 text-gray-400 border-3 border-white rounded-full shadow-default overflow-hidden focus:outline-none">
                ...
                <section className="grid gap-2 w-full px-8">
                    {leaderboard.map(({ name, photo, xp, }, i) => (
                        <IconButton
                            ...
                            icon={(
                                <div className="flex justify-center items-end w-12 h-12">
